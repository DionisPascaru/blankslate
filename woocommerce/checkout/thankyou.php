...
<div class="rm-order woocommerce-order">
    <?php if ($order) : do_action('woocommerce_before_thankyou', $order->get_id()); ?>
        ...
        <?php else : ?>
            ...
            <div class="rm-order-received rm-shadow-block">
                <div class="rm-order-block-title">
                    <?php esc_html_e('Order number:', 'woocommerce'); ?>
                    <?php echo $order->get_order_number(); ?>
                </div>
                <div class="rm-order-received-text">
                    <?php wc_get_template('checkout/order-received.php', array('order' => $order)); ?>
                </div>

                <ul class="rm-order-overview woocommerce-order-overview woocommerce-thankyou-order-details order_details">
