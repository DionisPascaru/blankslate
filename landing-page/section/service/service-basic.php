<?php ?>
<div class="rm-services-tab-content">
    <div class="rm-service-item rm-service-basic">
        <div class="accordion" id="serviceBasicAccordion"></div>
    </div>
</div>
<script>
    // accordionData
    const serviceBasicData = [
        {
    ...
    function generateAccordionItems(data, containerId) {
        ...
        data.forEach((item, index) => {
            ...
            const isFirst = index === 0 ? "show" : ""; // Open first item by default
            ...
            const accordionItem = `
                    <div class="accordion-item">
                        ...
                        <div id="${collapseId}" class="accordion-collapse collapse ${isFirst}" data-bs-parent="#${containerId}">
    ...
    generateAccordionItems(serviceBasicData, "serviceBasicAccordion");
</script>
