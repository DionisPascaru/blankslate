...
<div class="rm-services-tab-content">
    <div class="rm-service-item rm-service-grand">
        <div class="accordion" id="serviceGrandAccordion"></div>
    </div>
</div>
<script>
    // accordionData
    const serviceGrandData = [
        {
    ...
    generateAccordionItems(serviceGrandData, "serviceGrandAccordion");
</script>