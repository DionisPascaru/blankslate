<?php ?>
<div class="rm-modal rm-subsidiary-modal modal fade rm-subsidiary-modal-three" id="subsidiaryThree" tabindex="-1">
        ...
        <div class="rm-modal-content modal-content">
            <div class="rm-modal-header modal-header">
                <div class="rm-subsidiary-modal-logo">
                    ...
                    <div class="rm-subsidiary-modal-logo-text">Nr.3</div>
                </div>
            ...
            <div class="rm-modal-body modal-body">
                <ul class="nav nav-tabs rm-subsidiary-tabs" id="myTab" role="tablist">
                    <li class="rm-subsidiary-tab" role="presentation">
                        <div class="rm-subsidiary-tab-button active" id="subsidiaryThreeTeamTab" data-bs-toggle="tab" data-bs-target="#subsidiaryThreeTeamTabPane" type="button" role="tab" aria-selected="true">Echipa</div>
                    </li>
                    <li class="rm-subsidiary-tab" role="presentation">
                        <div class="rm-subsidiary-tab-button" id="subsidiaryThreeAboutTab" data-bs-toggle="tab" data-bs-target="#subsidiaryThreeAboutTabPane" type="button" role="tab" aria-selected="false">Despre</div>
                    </li>
                    <li class="rm-subsidiary-tab" role="presentation">
                        <div class="rm-subsidiary-tab-button" id="subsidiaryThreeGraphTab" data-bs-toggle="tab" data-bs-target="#subsidiaryThreeGraphTabPane" type="button" role="tab" aria-selected="false">Grafic</div>
                    </li>
                    <li class="rm-subsidiary-tab" role="presentation">
                        <div class="rm-subsidiary-tab-button" id="subsidiaryThreeContactTab" data-bs-toggle="tab" data-bs-target="#subsidiaryThreeContactTabPane" type="button" role="tab" aria-selected="false">Contacte</div>
                    </li>
                </ul>
